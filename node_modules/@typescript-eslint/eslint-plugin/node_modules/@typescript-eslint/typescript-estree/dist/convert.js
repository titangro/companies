...
function convert(config) {
    ...
    function convertBodyExpressions(nodes) {
        let allowDirectives = node_utils_1.canContainDirective(node);
        return (nodes
            .map(statement => {
    ...
    function convertTypeArgumentsToTypeParameters(typeArguments) {
        const greaterThanToken = node_utils_1.findNextToken(typeArguments, ast, ast);
        return {
            type: ast_node_types_1.AST_NODE_TYPES.TSTypeParameterInstantiation,
            range: [typeArguments.pos - 1, greaterThanToken.end],
            loc: node_utils_1.getLocFor(typeArguments.pos - 1, greaterThanToken.end, ast),
    ...
    function convertTSTypeParametersToTypeParametersDeclaration(typeParameters) {
        const greaterThanToken = node_utils_1.findNextToken(typeParameters, ast, ast);
        return {
            type: ast_node_types_1.AST_NODE_TYPES.TSTypeParameterDeclaration,
            range: [typeParameters.pos - 1, greaterThanToken.end],
            loc: node_utils_1.getLocFor(typeParameters.pos - 1, greaterThanToken.end, ast),
    ...
    switch (node.kind) {
        ...
        case SyntaxKind.MethodDeclaration: {
            const method = {
                ...
                loc: {
                    start: node_utils_1.getLineAndCharacterFor(node.parameters.pos - 1, ast),
                    end: result.loc.end
                }
            };
            if (node.type) {
        ...
        case SyntaxKind.Parameter: {
            ...
            if (node.dotDotDotToken) {
                ...
                if (node.modifiers) {
                    ...
                    result.loc = node_utils_1.getLocFor(result.range[0], result.range[1], ast);
                }
            }
            else {
            ...
            if (node.questionToken) {
                if (node.questionToken.end > parameter.range[1]) {
                    ...
                    parameter.loc = node_utils_1.getLocFor(parameter.range[0], parameter.range[1], ast);
                }
        ...
        case SyntaxKind.ClassExpression: {
            ...
            if (superClass) {
                if (superClass.types.length > 1) {
                    throw node_utils_1.createError(ast, superClass.types[1].pos, 'Classes can only extend a single class.');
                }
            ...
            Object.assign(result, {
                ...
                body: {
                    ...
                    loc: node_utils_1.getLocFor(classBodyRange[0], classBodyRange[1], ast)
                },
        ...
        case SyntaxKind.PropertyAccessExpression:
            if (node_utils_1.isJSXToken(parent)) {
        ...
        case SyntaxKind.MetaProperty: {
            const newToken = node_utils_1.convertToken(node.getFirstToken(), ast);
            Object.assign(result, {
        ...
        case SyntaxKind.JsxExpression: {
            const expression = node.expression
                ...
                : {
                    ...
                    loc: {
                        start: node_utils_1.getLineAndCharacterFor(result.range[0] + 1, ast),
                        end: {
        ...
        case SyntaxKind.JsxAttribute: {
            const attributeName = node_utils_1.convertToken(node.name, ast);
        ...
        case SyntaxKind.JsxText: {
            ...
            result.loc = node_utils_1.getLocFor(start, end, ast);
        ...
        case SyntaxKind.InterfaceDeclaration: {
            ...
            Object.assign(result, {
                ...
                body: {
                    ...
                    loc: node_utils_1.getLocFor(interfaceBodyRange[0], interfaceBodyRange[1], ast)
                },
                id: convertChild(node.name)
            });
